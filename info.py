...
BOT_TOKEN = environ['6296295298:AAG82Ph5DQjGVKwg4vSUyNyuLaW3YXL4A7E']
# Bot settings
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6032060494').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6032060494').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('1001847058383')
auth_grp = environ.get('1001294638101')
